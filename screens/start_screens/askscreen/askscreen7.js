...
export default function AskScreen7({ navigation }) {
  ...
  const resetScreen = () => {
    navigation.dispatch(StackActions.replace("Askscreen6"));
  };
  const Press1 = () => {
    global.time = "1 tháng";
